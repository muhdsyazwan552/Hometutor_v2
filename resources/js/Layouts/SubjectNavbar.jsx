...
export default function SubjectNavbar({ title }) {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-gray-100 bg-white shadow-sm px-6 ">
      ...
      <div className="mx-auto  px-3 sm:px-3 lg:px-3">
        <div className="flex h-20 items-center justify-between relative">
          ...
          <div className="flex items-center">
            ...
            >
              School Subject - {title} {/* Dynamically display the title */}
              <svg
              ...
              <div className="px-6 py-2 grid grid-cols-3 gap-4">
                <div>
                  ...
                  <ul className="text-sm text-sky-600 space-y-1">
                    ...
                    <li><Link href="/subject/matematik-tambahan">Matematik Tambahan</Link></li>
                  </ul>
                </div>
                {/* VideoTube */}
                <div>
